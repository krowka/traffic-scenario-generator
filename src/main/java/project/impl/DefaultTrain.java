...
public class DefaultTrain extends WrappedIndividualImpl implements Train {
    ...
    public Collection<? extends Road_segment> getVehicle_has_location() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
    ...
    public void addVehicle_has_location(Road_segment newVehicle_has_location) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_VEHICLE_HAS_LOCATION,
                                       newVehicle_has_location);
    }

    public void removeVehicle_has_location(Road_segment oldVehicle_has_location) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_VEHICLE_HAS_LOCATION,
